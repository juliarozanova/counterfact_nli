...
two_class_models = ['roberta-large-mnli-help']
...
def eval_on_nli_dataset(nli_dataset, encoder_model, encoder_model_name, batch_size=64):
    ...
    test_head = meta_df[['sentence1', 'sentence2', 'gold_label', 'y_true', 'y_pred']].loc[meta_df.label==0]
...
def interpret_predicted_label(predicted_label, rep_name):
    ...
    elif rep_name in three_class_models_0_is_entailment:
